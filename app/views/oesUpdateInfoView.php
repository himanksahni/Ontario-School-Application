                    ...
                    <form role="Form" method="POST" action="index.php?url=OesController&action=updateInfo">
						...
						<div class="form-group">
							...
							<input type="text" id="status" class="form-control" name="status" 
                               value="<?php echo$studentData['status']; ?>">
                        </div>
                        ...
                        ?>
							...
							<input type="text" id="status" class="form-control formHide" name="applicantId" 
                               value="<?php echo $studentData['applicantId']; ?>">
                        </div>
                        
                        <div class="form-group formHide">
							<input type="text" id="status" class="form-control formHide" name="schoolId" 
                               value="<?php echo $studentData['schoolId']; ?>">
                        </div>
