    ...
    <div class="container cards">
        ...
        <div class="row pt-4">
            <div class="col" align="center">
               <a href="index.php?url=OesController&action=getStudentApplicationInfo"> <div class="card " style="width: 18rem;">
                    <img class="card-img-top" src="./public/img/student_application.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">View Student Applications</h5>
                    </div>
                   </div> </a>
            </div>
        </div>
